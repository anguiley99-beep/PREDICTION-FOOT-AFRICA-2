...
const MOCK_INFO: Info[] = [{ id: 'info1', text: 'Bienvenue sur Prognos\'Foot Elite ! Le meilleur jeu de pronostics pour les fans de football. Participez, montrez vos talents de pronostiqueur et gagnez des prix incroyables. Bonne chance à tous !', imageUrl: 'https://picsum.photos/seed/info/800/400' }];
